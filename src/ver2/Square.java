...
public class Square extends Button implements Serializable {
    ...
    public void setChess(Chess chess) {
        if(chess != null) {
            this.chess = chess;               
            Loader.getIcon(this);
            /* Use following lines instead of line 121 can perform polymorphic image icon call.
             * However this will load image every time and very laggy.
             */
//            setGraphic(new ImageView(new Image(chess.getImageAddress())));
//            ((ImageView) getGraphic()).setFitHeight(90);
//            ((ImageView) getGraphic()).setFitWidth(45);
        }
        else {
            this.chess = null;
            setGraphic(null);
